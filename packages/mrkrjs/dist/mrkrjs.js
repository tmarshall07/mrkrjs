(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.mrkrjs = factory(global.tslib));
    ...
    var Mrkr = /** @class */ (function () {
        ...
        Mrkr.prototype.getData = function (className) {
            ...
            var highlightedTextNodes = this.getHighlightedNodes(className).reduce(function (arr, current) { return tslib.__spreadArray(tslib.__spreadArray([], arr, true), textNodesUnder(current), true); }, []);
            var currentIndex = 0;
...
//# sourceMappingURL=mrkrjs.js.map
